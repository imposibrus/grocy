...
DefaultUserSetting('show_purchased_date_on_purchase', true); // Whether the purchased date should be editable on purchase (defaults to today otherwise)
...
DefaultUserSetting('shopping_list_show_calendar', true); // When enabled, a small (month view) calendar will be shown on the shopping list page
DefaultUserSetting('shopping_list_auto_add_below_min_stock_amount', true); // If products should be automatically added to the shopping list when they are below their min. stock amount
...
// Recipe settings
DefaultUserSetting('recipe_ingredients_group_by_product_group', true); // Group recipe ingredients by their product group
...
DefaultUserSetting('recipes_show_ingredient_checkbox', true); // When enabled, a little checkbox will be shown next to each ingredient to mark it as done
